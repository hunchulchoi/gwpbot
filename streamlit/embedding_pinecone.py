...
def load_and_split_json_files(file_paths: list[str]):
  """
  ...
  for file_path in file_paths:
    ...
    store_documents_to_pinecone(docs, "gwp", EmbeddingModel.OPENAI)
    total_docs += len(docs)
...
def store_documents_to_pinecone(document_list:list, index_name: str, 
  embedding_model_type:EmbeddingModel=EmbeddingModel.UPSTAGE):
  """
...
def main():
  ...
  total_docs = load_and_split_json_files(file_paths)
